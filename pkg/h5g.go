...
func (self *Group) CreateGroup(name string, link_flags, grp_c_flags, grp_a_flags int) (g *Group, err os.Error) {
	g = nil
	err = nil
...
func (self *Group) OpenGroup(name string, gapl_flag int) (g *Group, err os.Error) {
	g = nil
	err = nil
...
func (g *Group) OpenDataType(name string, tapl_id int) (*DataType, os.Error) {
	c_name := C.CString(name)
	defer C.free(unsafe.Pointer(c_name))
